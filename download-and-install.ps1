<#
    ...
    requirements:
        - computer needs to reach this script, e.g. \\server\deployment
        - trigger needs to be deployes, e.g. via ESET Protect or Windows Scheduler
...
$app_name = "very nice app"
$search_name = "niceapp"
$url = "https://download/installation/file.msi"
$setup_file = "file.msi"
$workdir = "c:\install\"
